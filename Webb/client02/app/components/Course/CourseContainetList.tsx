...
const CourseContainerList: FC<Props> = (props) => {
  ...
  return (
    ...
    >
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        const sectionContentHours: number = sectionVideoLength / 60; // Convert total length to hours
            ...
            {isSectionVisible && (
              <div className="w-full">
                {sectionVideos.map((item: any, index: number) => {
                  ...
                  const contentLength: number = item.videoLength / 60; // Convert video length to hours
...
export default CourseContainerList;
